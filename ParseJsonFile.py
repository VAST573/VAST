...
def getCveInformation(nvd_json_dict):
    ...
    for cve in cve_items:
        ...
        cve_object = CveClass.Cve(cve_id_number, cve_impact_scoreV2, cve_impact_scoreV3, cve_last_published_date, cve_description)
...
print(cveInstanceList[0].getimpactScoreV2())
